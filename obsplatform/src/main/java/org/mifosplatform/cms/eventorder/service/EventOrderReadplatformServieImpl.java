...
public class EventOrderReadplatformServieImpl implements EventOrderReadplatformServie {
	...
	private static final class EventOrderMapper implements
		...
		public String schema() {
			return " eo.id AS id,eo.event_bookeddate AS bookedDate,em.event_name AS eventName,eo.charge_code AS chargeCode,if(em.event_category = 'Live Event',em.status,eo.event_status) as status,eo.booked_price AS price" +
