...
public class ClientsApiResource {
    ...
    public ClientsApiResource(final PlatformSecurityContext context, final ClientReadPlatformService readPlatformService,
            ...
            final ConfigurationRepository configurationRepository,final PaymentGatewayConfigurationRepository paymentGatewayConfigurationRepository,
    ...
    public String retrieveOne(@PathParam("clientId") final Long clientId, @Context final UriInfo uriInfo) {
        ...
        final Configuration paypalconfigurationProperty=this.configurationRepository.findOneByName(ConfigurationConstants.PAYMENTGATEWAY_IS_PAYPAL_CHECK);
